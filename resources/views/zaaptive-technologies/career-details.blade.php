...
<html lang="en">
    ...
    <head>
        ...
        <title>{{ $career->position }} - Careers at Zaaptive</title>
    ...
    <body class="bg-gray-900 text-white font-inter">
        ...
        <header class="bg-gradient-to-r from-blue-600 to-purple-700 py-16 text-center">
            <h1 class="text-4xl md:text-5xl font-bold">{{ Str::title($career->position) }}</h1>
            <p class="mt-3 text-lg text-gray-200">{{ Str::title($career->status) }} | {{ Str::title($career->experience) }} | {{ Str::upper($career->salary) }}</p>
            <a href="#apply"
        ...
        <section class="max-w-5xl mx-auto py-16 px-6 space-y-12">
            ...
            <div>
                ...
                <ul class="list-disc list-inside space-y-2 text-gray-300">
                    <li>{{ Str::title($career->description) }}</li>
                </ul>
            </div>
            ...
            <div id="apply" class="bg-gray-800 p-8 rounded-xl">
                ...
                <form class="space-y-4">
                    ...
                    <button type="submit"
                        class="w-full bg-blue-600 hover:bg-blue-700 py-3 rounded font-semibold">Submit
                        Application</button>
                </form>
            </div>
